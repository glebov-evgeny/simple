    ...
    <div class="s-popup-cookie__content" :class="[{ animated: isAnimated }]" @click.stop>
      ...
      <div class="s-popup-cookie__box">
        ...
        <p class="s-popup-cookie-description s-description">
          На&nbsp;этом сайте используются <b>cookie</b>, и&nbsp;это нормально. Но&nbsp;стоит предупредить на&nbsp;всякий
          случай.
        </p>
        <button class="s-popup-cookie-button" @click.stop="popupIsClosedWithAgreement">Ну ок</button>
      </div>
    </div>
  </div>
</template>
